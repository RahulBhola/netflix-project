...
const Movies = () => {
    ...
    return (
        <div className='relative bg-black -top-20'>
            <div className='relative text-white font-bold text-2xl px-12 py-2 '>Watch Movies</div>
            <div className="relative container mx-auto pb-8 px-12">
                            ...
                            <div className="relative w-full h-96">
                                ...
                                {!isPlaying ? (
                                    <div className="absolute inset-0 flex justify-center items-center text-white" 
                                        onClick={handleMovieVideoPlayClick}
                                    >
                                        <div className="group">
                                    ...
                                    <div className="absolute inset-0 flex justify-center items-center text-white" 
                                        onClick={handleMovieVideoPauseClick}
                                    >
                                        <div className="group">
